 ...
 * @author desmond
 */
public class CorpixException extends CalliopeException
{
    /**
     * Create a general MMLException from scratch
     * @param message the message it is to bear
     */
    public CorpixException( String message )
    {
        super( message );
    }
    /**
     ...
     */
    public CorpixException( Exception e )
    {
        super( e );
    }
}
