...
import corpixmgr.handler.CorpixGetHandler;
...
import corpixmgr.handler.CorpixPostHandler;
...
public class JettyServer extends AbstractHandler
{
        ...
        throws IOException, ServletException
    {
        ...
        try
        {
            ...
            if ( service.equals(Service.CORPIX) )
            {
                String urn = Utils.pop(target);
                if ( method.equals("GET") )
                    new CorpixGetHandler().handle( request, response, urn );
                else if ( method.equals("POST") )
                    new CorpixPostHandler().handle(request, response, urn );
                else
                    throw new CorpixException("Unknown http method "+method);
            }
            else
                throw new CorpixException("Unknown service "+service);
        }
        catch ( CorpixException ce )
        {
